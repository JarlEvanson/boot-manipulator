...
/// # Errors
///
/// If [`BootInterface::initialize_logger()`] fails, this function returns that error.
///
/// # Panics
///
...
pub fn initialize_logging(
    filter: LevelFilter,
) -> Result<(), <BootInterface as BootOps>::LoggingInitializationError> {
    *ACTIVE_LOGGER.lock() = BootInterface::initialize_logger()?;
